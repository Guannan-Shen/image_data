...
x_train, y_train, x_test, y_test = load_raw_data(image_size=(IMG_HEIGHT, IMG_WIDTH))
...
for i, (train_index, valid_index) in enumerate(kfold.split(x_train)):
    ...
    if i == 0:
        ...
        if True:
            u_net = NeuralNetwork(nn_name=nn_name[0], log_step=1.0, input_shape=(IMG_HEIGHT, IMG_WIDTH, 3),
                                  output_shape=(IMG_HEIGHT, IMG_WIDTH, 1))  # Create instance of neural network.
